...
<!-- <div class="equation" align="center" data-raw-text="M_X(t) := \mathbb{E}\!\left[e^{tX}\right] = 1 +\sum_{k=1}^{\infty} \left( \prod_{r=0}^{k-1} \frac{\alpha+r}{\alpha+\beta+r} \right) \frac{t^k}{k!}" data-equation="eq:beta_mgf">
    <img src="https://cdn.jsdelivr.net/gh/stdlib-js/stdlib@6a4d9614841138f791bfad6fc7d694dffff81a6c/lib/node_modules/@stdlib/stats/base/dists/beta/mgf/docs/img/equation_beta_mgf.svg" alt="Moment-generating function (MGF) for a beta distribution.">
    <br>
</div> -->
